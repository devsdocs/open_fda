...
final class OtherNationalDrugCodeStructuredProductLabelingDataElements
  ...
  Endpoints get endPointBase =>
      Endpoints.otherNationalDrugCodeStructuredProductLabelingDataElements;
  ...
  final String applicationNumberOrCitation = 'application_number_or_citation';
  ...
  final String billingUnit = 'billing_unit';
  ...
  final String inactivationDate = 'inactivation_date';
  ...
  final String packageNdc = 'package_ndc';
  ...
  /// transformed.
  final String packageNdc11 = 'package_ndc11';
  ...
  /// data is reactivated.
  final String reactivationDate = 'reactivation_date';
}
